...
const Contact = () => {
    return (
        <div className="h-full w-full flex flex-col mb-20 bg-[#f9f9f9]">
            ...
            <div className="mt-10 lg:mx-10 h-full bg-white p-4 rounded-[8px] flex w-[90%] mx-6 lg:flex-row flex-col my-10 lg:my-0">
                <div className="lg:w-1/3 w-full flex flex-col bg-[#4f4138] text-white rounded-[10px] lg:p-20 p-12">
                    ...
                    <div className="flex flex-col w-full h-full gap-y-12 mt-12">
                        <p className="flex gap-x-5 justify-start">
                            <Phone fill="white" color="black" className="h-6 w-6 lg:w-8 lg:h-8"/>
                            +91 80186 95050
                        </p>
                        <p className="flex gap-x-5 break-all justify-start">
                    ...
                    <div className="flex w-full gap-x-8 lg:mt-40 mt-24 cursor-pointer">
                        <Twitter />
                        <Instagram />
                        <Facebook />
                    </div>
